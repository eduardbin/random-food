...
function showNewMenu(mainFood, dessertFood, drinkFood) {
  ...
  var allPrice = 0;
  var allMass = 0;
  var notChecket = 'Не выбрано';
  var notChecketImg = 'assets/img/intro_bg.jpg';
  ...
  ;
  var newMenu = menuTmplt.replace(/{}allPrice{}/ig, allPrice).replace(/{}allMass{}/ig, allMass);

  if (mainFood != undefined) {
    newMenu = newMenu.replace(/{}mainImg{}/ig, mainFood.foodImg).replace(/{}mainName{}/ig, mainFood.foodName).replace(/{}mainPrice{}/ig, mainFood.foodPrice).replace(/{}mainMass{}/ig, mainFood.foodMass).replace(/{}mainIngredients{}/ig, mainFood.foodIngredients);
  } else {
    newMenu = newMenu.replace(/{}mainImg{}/ig, notChecketImg).replace(/{}mainName{}/ig, notChecket).replace(/{}mainPrice{}/ig, notChecket).replace(/{}mainMass{}/ig, notChecket).replace(/{}mainIngredients{}/ig, notChecket);
  }

  ;

  if (dessertFood != undefined) {
    newMenu = newMenu.replace(/{}dessertImg{}/ig, dessertFood.foodImg).replace(/{}dessertName{}/ig, dessertFood.foodName).replace(/{}dessertPrice{}/ig, dessertFood.foodPrice).replace(/{}dessertMass{}/ig, dessertFood.foodMass).replace(/{}dessertIngredients{}/ig, dessertFood.foodIngredients);
  } else {
    newMenu = newMenu.replace(/{}dessertImg{}/ig, notChecketImg).replace(/{}dessertName{}/ig, notChecket).replace(/{}dessertPrice{}/ig, notChecket).replace(/{}dessertMass{}/ig, notChecket).replace(/{}dessertIngredients{}/ig, notChecket);
  }

  ;

  if (drinkFood != undefined) {
    newMenu = newMenu.replace(/{}drinkImg{}/ig, drinkFood.foodImg).replace(/{}drinkName{}/ig, drinkFood.foodName).replace(/{}drinkPrice{}/ig, drinkFood.foodPrice).replace(/{}drinkMass{}/ig, drinkFood.foodMass).replace(/{}drinkIngredients{}/ig, drinkFood.foodIngredients);
  } else {
    newMenu = newMenu.replace(/{}drinkImg{}/ig, notChecketImg).replace(/{}drinkName{}/ig, notChecket).replace(/{}drinkPrice{}/ig, notChecket).replace(/{}drinkMass{}/ig, notChecket).replace(/{}drinkIngredients{}/ig, notChecket);
  }
...
module.exports = __webpack_require__(/*! E:\Sites\Beetroot-academy\main-project\random-food\src\assets\js\app.js */"./src/assets/js/app.js");
